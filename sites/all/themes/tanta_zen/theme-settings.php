 ...
 */
function tanta_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['tanta_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('tanta_zen sample setting'),
  '#default_value' => theme_get_setting('tanta_zen_example'),
